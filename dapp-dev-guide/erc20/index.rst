...
The final code is available in `GitHub <https://github.com/CasperLabs/erc20>`_. If you haven't read `Writing Rust Contracts on CasperLabs <../writing-rust-contracts.html>`_ , we recommend you start there. 
