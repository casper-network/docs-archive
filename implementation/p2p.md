...
In practice this means that if we have a network of 50 nodes and a _k_ of 10,
...
Having a _relay factor_ together with the mechanism of returning whether the
